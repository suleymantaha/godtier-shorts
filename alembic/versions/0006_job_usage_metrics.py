...
def upgrade() -> None:
    op.create_table(
        ...
        sa.CheckConstraint("source_seconds >= 0", name="ck_job_usage_metrics_source_seconds_nonnegative"),
        sa.CheckConstraint("gpu_seconds >= 0", name="ck_job_usage_metrics_gpu_seconds_nonnegative"),
        sa.CheckConstraint("estimated_internal_cost_usd >= 0", name="ck_job_usage_metrics_cost_nonnegative"),
